...
@section('content')
    <div class="box">
        <div class="box-header">
            <a href="{{ route('servicos.create') }}" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Adicionar</a>
        </div>
                ...
                @foreach ($services as $item)
                    <tr>
                        ...
                        <td class="action" style="display: flex; justify-content: center;">
                            <a href="{{ route('servicos.edit', $item->id) }}" class="btn btn-primary">Editar</a>
